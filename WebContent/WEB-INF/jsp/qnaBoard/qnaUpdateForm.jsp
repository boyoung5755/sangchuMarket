            ...
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group control-group-right">
                            <input type="text" class="form-control" id="cm_title" value="<%=vo.getCm_title() %>"
                        ...
                        <div class="control-group control-group-right">
                            <textarea class="form-control" rows="8" id="cm_content" placeholder="내용을 입력하세요"
                                required="required"
                                data-validation-required-message="Please enter your message"><%=vo.getCm_content() %></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                            <button class="btn btn-primary py-2 px-4 control-sand" type="button" id="sendMessageButton" >문의 수정</button>
