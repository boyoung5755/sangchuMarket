...
public interface IChatDao {
	/*
		...
		최근 수정자 : 김석호
		최근 수정일 : 2023.08.20 22:02
		
		수정내역
		2023.08.10 01:30 - 김석호 : 이미지파일명 가져오는 메소드 추가
		2023.08.17 10:16 - 김석호 : 새로운 채팅방을 만들기 위한 메소드 추가
		2023.08.18 11:29 - 김석호 : 채팅방을 통한 거래 관련 메소드 추가
		2023.08.19 13:14 - 김석호 : 채팅방 연계 관련 메소드 추가
		2023.08.20 22:02 - 김석호 : 채팅방 연계 관련 메소드 추가
	...
	*/
	...
	/**
	 * 채팅방 번호로 거래글 작성자 이메일을 받아오는 메소드
	 * @param c_no 채팅방 번호
	 * @return 해당 채팅방이 종속된 거래글의 작성자 email
	 */
	 ...
	 * 거래글의 정보를 가져오는 메소드
	 * @param c_no 채팅방번호
	 * @return 채팅방번호에 해당하는 거래글 정보를 가져오는 메소드
	 */
	public TBoardOfferVO getTBoardInfoByCNO(String c_no);
	
	/**
	 * 채팅방 번호로 거래글 번호를 가져오는 메소드
	 * @param c_no 채팅방 번호
	 * @return 채팅방이 종속되어있는 거래글의 번호
	 */
